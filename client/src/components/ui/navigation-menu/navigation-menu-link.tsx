        ...
        <NavigationMenuPrimitive.Link
            ...
            className={cn(
                'data-[active=true]:focus:bg-accent data-[active=true]:hover:bg-accent ' +
                    ...
                    "focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col " +
                    'gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] ' +
